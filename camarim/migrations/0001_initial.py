# Generated by Django 5.2.4 on 2025-08-04 22:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', models.ImageField(blank=True, null=True, upload_to='evento/%Y/%m')),
            ],
        ),
        migrations.CreateModel(
            name='Produto',
            fields=[
                ...
                ('descricao', models.TextField(blank=True)),
                ('categoria', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produtos', to='camarim.categoria')),
            ],
        ),
        migrations.CreateModel(
            name='Estoque',
            fields=[
                ...
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estoques', to='camarim.produto')),
            ],
        ),
        migrations.CreateModel(
            name='Proposta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100)),
                ('evento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='salas', to='camarim.evento')),
            ],
        ),
        migrations.CreateModel(
            name='EstoqueSala',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantidade', models.PositiveIntegerField()),
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estoque_em_salas', to='camarim.produto')),
                ('sala', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estoque_salas', to='camarim.sala')),
            ],
            options={
                'verbose_name': 'Estoque em Sala',
                'verbose_name_plural': 'Estoques em Salas',
